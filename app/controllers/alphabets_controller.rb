class AlphabetsController < ApplicationController
  before_action :set_alphabet, only: [:show]

  # GET /alphabets
  # GET /alphabets.json
  def index
    @alphabets = Alphabet.all
    render json: @alphabets.to_json(include: :cards)
  ...
  def show
    render json: @alphabet.to_json(include: :cards)
  ...
  private
    ...
    def alphabet_params
      params.require(:alphabet).permit(:alp_name)
    end
end
